package com.eastvirus.boardserver.service.impl;

import com.eastvirus.boardserver.exception.DuplicateIdException;
import com.eastvirus.boardserver.dto.UserDTO;
import com.eastvirus.boardserver.mapper.UserProfileMapper;
import com.eastvirus.boardserver.service.UserService;
import com.eastvirus.boardserver.utils.SHA256Util;
...
public class UserServiceImpl implements UserService {
    ...
    public void register(UserDTO userDTO) {
        boolean dupIdResult = isDuplicatedId(userDTO.getUserId());
        if (dupIdResult) {
